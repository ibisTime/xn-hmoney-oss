...
export default class CSearchSelect extends React.Component {
    ...
    isPropsChange(nextProps) {
        const {
            field, rules, readonly, getFieldValue, hidden, initVal,
            inline, keyName, valueName, searchName, pageCode, isLoaded, params
        } = this.props;
    ...
    render() {
        const {
            ...
            onChange, initVal, inline, keyName, valueName, isLoaded, code
        } = this.props;
        const {list} = this.state;
