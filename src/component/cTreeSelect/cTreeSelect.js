...
export default class CTreeSelect extends React.Component {
    ...
    isPropsChange(nextProps) {
        const {
            field, isLoaded, rules, readonly, bParams, keyName,
            valueName, getFieldValue, hidden, initVal, inline, list
        } = this.props;
    ...
    render() {
        const {
            ...
            onChange, initVal, inline, list, keyName, valueName, isLoaded, disabled
        } = this.props;
