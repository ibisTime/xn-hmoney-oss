...
import {initData, setSelectedKeys, addPost, deletePost, updatePost} from '@redux/system/post';
...
class Post extends React.Component {
    ...
    render() {
        ...
        const {
            btnList, treeData, selectedKeys, checkedKeys,
            defaultExpandedKeys, fetching, current
        } = this.props;
        const {getFieldDecorator} = this.props.form;
        return (
            <div>
                <PostAdd addPost={this.props.addPost} parentCode={selectedKeys[0]} postVisible={postVisible}
                         setPostVisible={this.setPostVisible}/>
