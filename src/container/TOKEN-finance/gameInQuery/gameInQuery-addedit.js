...
import {
    ...
    setPageData,
    restore
} from '@redux/TOKEN-finance/gameInQuery/gameInQuery-addedit';
...
@DetailWrapper(
    state => state.TOKENFinanceGameInQueryAddEdit,
    {initStates, doFetching, cancelFetching, setSelectData, setPageData, restore}
)
class GameInQueryAddedit extends React.Component {
    constructor(props) {
        super(props);
...
export default GameInQueryAddedit;
